...
public class HelixController : MonoBehaviour
{
    ...
    public void LoadStage(int stageNumber)
    {
        ...
        stage = allStages[Mathf.Clamp(stageNumber, 0, allStages.Count - 1)];
        ...
        foreach (BallController ballController in FindObjectsOfType<BallController>())
        {
            ballController.GetComponent<Renderer>().material.color = allStages[stageNumber].stageBallColor;
        }
